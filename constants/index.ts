...
export const VERTICAL_BASELINE_GAIN = 2; // inches per valid post
export const VERTICAL_MISS_PENALTY = 3; // inches lost per missed day
export const VERTICAL_MAX_HEIGHT = 120; // 10 feet
